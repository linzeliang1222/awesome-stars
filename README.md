...
*   [JanePHPDev/ZuzShortURL](https://github.com/JanePHPDev/ZuzShortURL) - 这是一个基于PHP开发、使用PostgreSQL数据库的极简短链接系统，前端采用 TailwindCSS，并针对Vercel做了专门的部署优化。可使用Supabase提供的免费数据库，5 分钟可上线。
